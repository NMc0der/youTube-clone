...
export const videos = [
  {
    id: "1",
    title: "Amazon VS Temu Dirt Bikes Challange",
    channel: {
      name: "JStuStudios",
      id: "JStuStudios",
      profileUrl:
    ...
    duration: 1438,
    thumbnailUrl:
      "https://i.ytimg.com/vi/UPPD-UkfWNM/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLCmRZiDjlqAyl32jL6rpVWqqYnAjA",
    videoUrl:
  ...
  },
  {
    id: "2",
    title:
      "Demetrious Johnson Teaches Death Sentence Stricking, BJJ & Training",
    channel: {
      name: "Mighty",
      id: "Mighty",
      profileUrl:
    ...
    views: 1117136,
    postedAt: new Date("2024-011-22"),
    duration: 2822,
    thumbnailUrl:
      "https://i.ytimg.com/vi/F8ncuTpkt88/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLCvLpaLzxYqXP-yZqSL2yzC22_veg",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
    id: "3",
    title: "I Collected Every Block In Minecraft",
    channel: {
      name: "Carvs",
      id: "Carvs",
      profileUrl:
    ...
    views: 2532300,
    postedAt: new Date("2025-1-05"),
    duration: 1961,
    thumbnailUrl:
      "https://i.ytimg.com/vi/tLgA9QdocqQ/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLCTxJl_lXhQvRvFJX5ldgvIkooWBQ",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
    id: "4",
    title: "CO-WORKERS WITH OUR FRIENDS FOR THE DAY !!",
    channel: {
      name: "B N S",
      id: "BNS",
      profileUrl:
    ...
    views: 633333,
    postedAt: new Date("2024-2-19"),
    duration: 2543,
    thumbnailUrl:
      "https://i.ytimg.com/vi/5_Z-qV2ihpg/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLA-UVi3h-9zouWiAt7SV28eXE_05g",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
    id: "5",
    title: "I Hid in Viral YouTube Videos and Nobody Noticed...",
    channel: {
      name: "Airrack",
      id: "Airrack",
      profileUrl:
    ...
    duration: 1034,
    thumbnailUrl:
      "https://i.ytimg.com/vi/yVWvuD9aTTA/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLDcKJQBscsJP9pa_NxMRMTRnq4-dQ",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
    ...
    duration: 1882,
    thumbnailUrl:
      "https://i.ytimg.com/vi/Q56PMJbCFXQ/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLCkcCqL3eTKBuSZOF8LOjSkb9U8rg",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
    id: "7",
    title: "The Smashing Machine Trailer",
    channel: {
      name: "A24",
      id: "A24",
      profileUrl:
    ...
    views: 10323340,
    postedAt: new Date("2025-04-29"),
    duration: 100,
    thumbnailUrl:
      "https://i.ytimg.com/vi/aRpnP3LZ99g/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLBupFV28HtF-RCDia918FwuPxJZFw",
    videoUrl:
      "https://storage.googleapis.com/gtv-videos-bucket/sample/ForBiggerJoyrides.mp4",
  },
  {
    id: "8",
    title: "Revealing 5 Secret Magic Tricks with Science",
    channel: {
      name: "CrunchLabs",
      id: "CrunchLabs",
      profileUrl:
        "https://i.ytimg.com/vi/02k8vRi5f_I/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLB92YHgVjvk1DpaH_FyvLEOPrS-gA",
    },
    views: 2323340,
  ...
  {
    id: "9",
    title: "I Tested VIRAL Beauty Products you won't believe",
    channel: {
      name: "HopeScope",
      id: "HopeScope",
      profileUrl:
  ...
  {
    id: "10",
    title: "A MINECRAFT Movie in LEGO...",
    channel: {
      name: "Mr.Bricks",
      id: "Mr.Bricks",
      profileUrl:
  ...
  {
    id: "11",
    title: "Taskmaster Season 19, Episode 1 - 'Sometimes spit' ",
    channel: {
      name: "Taskmaster",
      id: "Taskmaster",
      profileUrl:
  ...
  {
    id: "12",
    title: "I Gave My CREDIT CARD To AGES 1-18",
    channel: {
      name: "Jordan Matter",
      id: "JordanMatter",
      profileUrl:
  ...
  {
    id: "14",
    title: "CboysTV Cheap Car Challange",
    channel: {
      name: "CboysTV",
      id: "CboysTV",
      profileUrl:
  ...
  {
    id: "15",
    title: "Surviving 24 Hours In a Private Jet!",
    channel: {
      name: "Unspeakable",
      id: "Unspeakable",
      profileUrl:
  ...
  {
    id: "16",
    title: "This is Our LAST Family VACATION!",
    channel: {
      name: "The Ninja Fam!",
      id: "TheNinjaFam!",
      profileUrl:
  ...
  {
    id: "17",
    title: "Can We Drop A Coin Into A Piggy Bank From 45m",
    channel: {
      name: "How Ridiculous",
      id: "HowRidiculous",
      profileUrl:
  ...
  {
    id: "18",
    title: "We Built The World's First HELLEPHANT Swapped SUPRA!",
    channel: {
      name: "ScrapLifeLee",
      id: "ScrapLifeLee",
      profileUrl:
  ...
  {
    id: "19",
    title: "ELDEN RING NIGHTREIGN Trailer",
    channel: {
